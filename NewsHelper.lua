...
function main()
   ...
   autoupdate("https://raw.githubusercontent.com/Decodir/auto-update/main/update.json", '['..string.upper(thisScript().name)..']: ', "тут ссылка на ваш сайт/url вашего скрипта на форуме (если нет, оставьте как в json)")
